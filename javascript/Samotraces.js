...
(function(factory) {
	...
	var Samotraces = Σ;
	/**
	 * @property {Boolean} [debug=false]me
	...
	on_change: function(e) {
	   ...
	   //<<mehdi
		for( var i=0, file; file = files[i]; i++) {
			...
			textarea_el.setAttribute('id','trace');
			textarea_el.setAttribute('cols',70);
			...
			reader.onload = (function(el,parser,trace) {
				return function(e) {
					...
					//textarea_el.appendChild(document.createTextNode(e.target.result));//Mehdi
